        ...
        <tbody className="divide-y divide-gray-800">
          {students.map((student) => (
            <tr key={student.id} className="hover:bg-[#1e293b] transition-colors">
              ...
              <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{student.branch}</td>
              <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{student.section}</td>
