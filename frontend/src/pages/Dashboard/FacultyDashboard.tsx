...
import FacultyContentUpload from '../../components/Faculty/FacultyContentUpload';
...
const FacultyDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'timetable' | 'content'>('overview');
  ...
  return (
    <div className="space-y-10">
      {/* Tab Navigation */}
      <div className="flex flex-wrap items-center gap-4 bg-white/5 backdrop-blur-md p-2 rounded-2xl border border-white/10 w-fit">
        <button
      ...
      {activeTab === 'timetable' && (
        <div className="bg-white dark:bg-dark-card/45 backdrop-blur-md rounded-[40px] p-8 md:p-12 border border-slate-50 dark:border-white/5 shadow-2xl">
          <FacultyTimetable />
        </div>
      )}
