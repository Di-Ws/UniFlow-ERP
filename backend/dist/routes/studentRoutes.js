...
router.post("/", authMiddleware_1.verifyToken, controller.createStudent);
...
router.put("/:id", authMiddleware_1.verifyToken, controller.updateStudent);
router.delete("/:id", authMiddleware_1.verifyToken, controller.deleteStudent);
